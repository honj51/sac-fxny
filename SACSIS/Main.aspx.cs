                ...
                if (nodeRoleId.Contains(roleId))
                {
                    ...
                    else
                    {
                        if (i == 0)
                            ...
                            if (dr[i][1].ToString() == "光伏")
                                sb.AppendFormat("<a id=\"menu{4}\" runat=\"server\"  href=\"javascript:SetUrl('{0}','{1}','{2}')\" onclick=\"changeMenu({4})\" hidefocus=\"true\">{3}</a>", 2, dr[i][0], dr[i][6], dr[i][1], c);
                            else if (dr[i][1].ToString() == "水电")
                                sb.AppendFormat("<a id=\"menu{4}\" runat=\"server\"  href=\"javascript:SetUrl('{0}','{1}','{2}')\" onclick=\"changeMenu({4})\" hidefocus=\"true\">{3}</a>", 3, dr[i][0], dr[i][6], dr[i][1], c);
                            else if (dr[i][1].ToString() == "火电")
                                sb.AppendFormat("<a id=\"menu{4}\" runat=\"server\"  href=\"javascript:SetUrl('{0}','{1}','{2}')\" onclick=\"changeMenu({4})\" hidefocus=\"true\">{3}</a>", 4, dr[i][0], dr[i][6], dr[i][1], c);
                            else if (dr[i][1].ToString() == "分布式")
                                sb.AppendFormat("<a id=\"menu{4}\" runat=\"server\"  href=\"javascript:SetUrl('{0}','{1}','{2}')\" onclick=\"changeMenu({4})\" hidefocus=\"true\">{3}</a>", 5, dr[i][0], dr[i][6], dr[i][1], c);
                            else if (dr[i][1].ToString() == "生物质")
                                sb.AppendFormat("<a id=\"menu{4}\" runat=\"server\"  href=\"javascript:SetUrl('{0}','{1}','{2}')\" onclick=\"changeMenu({4})\" hidefocus=\"true\">{3}</a>", 6, dr[i][0], dr[i][6], dr[i][1], c);
                            else
                            {
                                sb.AppendFormat("<a id=\"menu{4}\" runat=\"server\"  href=\"javascript:SetUrl({0},{1},{2})\" onclick=\"changeMenu({4})\" hidefocus=\"true\">{3}</a>", 0, dr[i][0], dr[i][6], dr[i][1], c);
                            }
